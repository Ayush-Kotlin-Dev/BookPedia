...
import com.ayush.book.core.presentation.LightBlue
...
@Composable
fun BookListItem(
    book: Book, onBookClick: (Book) -> Unit, modifier: Modifier = Modifier
) {
    Surface(
        shape = RoundedCornerShape(32.dp),
        modifier = modifier.clickable(onClick = { onBookClick(book) }),
